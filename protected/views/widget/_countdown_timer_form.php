...
?>
<script type="text/javascript" src="<?php echo Yii::app()->baseUrl.'/themes/cnktheme/js/jquery.datetimepicker.js'; ?>" >
</script>
<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->baseUrl.'/themes/cnktheme/js/jquery.datetimepicker.css'?>">
<div class="form">
...
?>
	<h3><?php  if($model->isNewRecord){ echo 'Create';}else{echo 'Update';}?> CountDown Timer ##</h3>
    ...
    <div class="control-group">
        <?php echo $form->labelEx($model,'Countdown date-Time'); ?>
        <div class="controls">
            <?php echo $form->textField($model,'countdown_time',array('size'=>60,'maxlength'=>250,'class'=>'input-large','value' =>(!$model->isNewRecord) ?$modelData->countdown_time:'')); ?>
            <?php echo $form->error($model,'name'); ?>
        </div>
    </div>
