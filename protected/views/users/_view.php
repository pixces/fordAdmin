...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_shortlisted')); ?>:</b>
	<?php echo CHtml::encode($data->is_shortlisted); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_winner')); ?>:</b>
	<?php echo CHtml::encode($data->is_winner); ?>
	<br />
