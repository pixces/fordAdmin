 ...
 * @author              Mohammed Sadik <mail.sadikp@gmail.com>
 * @version             0.1
 * @license             BSD License
 */ 

/**
 * Hybrid_Providers_Flickr - Flickr provider adapter based on OAuth1 protocol
 */
class Hybrid_Providers_Flickr extends Hybrid_Provider_Model_OAuth1
{
	...
	function initialize() 
	{
		...
		$this->api->api_base_url      = 'https://www.flickr.com/rest/';
		$this->api->authorize_url     = 'https://www.flickr.com/services/oauth/authorize';
		$this->api->request_token_url = 'https://www.flickr.com/services/oauth/request_token';
		$this->api->access_token_url  = 'https://www.flickr.com/services/oauth/access_token';
	}
