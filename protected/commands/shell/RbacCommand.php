...
EOD;
    ...
    public function run($args)
    {
        ...
        echo "This command will create Two roles: Admin, subAdmin, and the following premissions:\n";
        echo "create, read, update and delete Gallery\n";
        echo "create, read, update and delete Content\n";
        echo "create, read, update and delete Pages\n";
        ...
        if(!strncasecmp(trim(fgets(STDIN)),'y',1))
        {
            ...
            $this->_authManager->createOperation("createContent","create a new Content");
            $this->_authManager->createOperation("readContent","read content information");
            $this->_authManager->createOperation("updateContent","update a content information");
            $this->_authManager->createOperation("deleteContent","remove a content from gallery");
